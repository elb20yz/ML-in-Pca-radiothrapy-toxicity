...
%               ];
str_fea = ["FOS_no_4";"GlSZM_no";"Wavelet_haar";"GLRLM_ang0";"GLRLM_ang45";"GLRLM_ang90";"GLRLM_ang135";...
            "GLRLM_average_6";"GLCM_D1_ang0";"GLCM_D3_ang0";"GLCM_D1_ang45_orig(ang135)";"GLCM_D3_ang45_orig(ang135)_6";"GLCM_D1_ang90";...
            "GLCM_D3_ang90";"GLCM_D1_ang135_orig(ang45)";"GLCM_D3_ang135_orig(ang45)";"GLCM_average_dis_ang_727";"GLDZM_3X32";"GLDZM_5X5";...
              ];
...
all_Bayex_store = [];
all_Bayey_store = [];
all_xaxis_store =cell(19,1);
all_yaxis_store =cell(19,1);
all_axis_store =cell(19,1);
Mean_AUC_store = ["SVM","KNN","Baye","Feature name"];
for q =1:19
    na = str_fea(q)
    load("together\"+str_fea(q)+"_axis.mat")
%     str_var = str_fea(1);
%     eval( [str_var, '= 10']);
