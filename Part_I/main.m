...
str_fea = ["FOS_no";"GLCM_D1_ang0";"GLCM_D1_ang45";"GLCM_D1_ang90";"GLCM_D1_ang135";"GLCM_D3_ang0";"GLCM_D3_ang45";...
            "GLCM_D3_ang90";"GLCM_D3_ang135";"GLCM_average_dis_ang";"GLDZM_3X3";"GLDZM_5X5";"GLRLM_ang0";"GLRLM_ang45";"GLRLM_ang90";"GLRLM_ang135";"GLRLM_average";...
            "GlSZM_no";"Wavelet_haar"];
...
for idk_nam = 1:size(str_fea,1)
    ...
    re_matrix = PCA_res(feature_matrix); % only with PCA
    


    % with Chi-square test selection and PCA here only for Wavelet. 
