...
function structure_param = param_check_return(main_type,parameter_type)
    ...
    PolynomialOrder = ["[]";2;3;"[]";"[]";"[]"];
    KernelScale = ["auto";"auto";"auto";2.7;11;43];
    ...
    Exponent = ["[]";"[]";"[]";"[]";3;"[]"];
    NumNeighbors = [50;10;1000;150;100;100];
    DistanceWeight = ["SquaredInverse";"Equal";"Equal";"SquaredInverse";"SquaredInverse";"SquaredInverse"];
